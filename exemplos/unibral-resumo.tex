...
% Informações gerais
%
\title{Um Exemplo de Resumo Estendido para o Programa UNIBRAL}
...
\advisorDE[Prof.~Dr.~Dr.]{Zuse}{Konrad}
\coadvisorDE[Prof.~Dr.]{Knuth}{Donald Ervin}
...
\subsubsection{Classificação dos etc.}
...
\subsection{Sobre as referências bibliográficas}
...
% \section{Mais estado da arte}
% \section{A minha contribuição}
% \section{Prova de que a minha contribuição é válida}
% \section{Conclusão}
